...
public class ArticleController extends BaseController implements ArticleControllerApi {
    ...
    public GraceResult createArticle(@Valid NewArticleBO newArticleBO, BindingResult result) {
        ...
        }else if (newArticleBO.getArticleType().equals(ArticleCoverType.WOEDS.type)){
    ...
    private List<AppUserVO> getPublisherList(Set<String> idSet) {
        String userServerUrlExecute = "http://admin.sn.com:8003/user/queryByIds?userIds=" + JsonUtil.objectToJson(idSet);
